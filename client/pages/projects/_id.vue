    ...
    <v-container class="">
        ...
        <v-row class="pa-2" no-gutters>
            ...
            <v-col class="col col-12 col-md-8">
                ...
                <h2 v-if="project.areas" class="text-h5 mt-2">
                    Области технологий:
                </h2>
                ...
                <div v-if="project.teamlead" class="text--secondary mb-5">
                    ...
                    >
                        <v-img
                            v-if="project.teamlead.avatar"
                            :src="base + project.teamlead.avatar"
                        ></v-img>
                        <div v-else>
                ...
                <div
                    v-if="project.contributors"
                    class="my-4 d-flex justify-start"
                >
                    <TeamItem

   ...
   <v-container class="mt-4 pa-2">
        <v-row no-gutters>
            ...
            <v-col class="col col-12 col-md-8">
                ...
                <v-container v-if="graduates.length" class="d-flex justify-start flex-wrap">
                    <GraduatesCard v-for="(grad, index) in graduates" :key="index" :item="grad" class="grad_card mt-2 mr-0 mr-md-2 mb-2"></GraduatesCard>
                </v-container>
                <NoInfo v-else/>
            </v-col>
            <v-col class="d-md-flex d-none"/>

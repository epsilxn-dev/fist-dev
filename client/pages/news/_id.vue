            ...
            <v-col class="col col-md-8 col-12">
                ...
                <v-card>
                    <v-card-text class="">
                        ...
                        <div
                            v-html="newsItem.text"
                            class="news-paragraph-image mt-4"
                        />
                    </v-card-text>
                </v-card>
                <div class="w-100 comments" v-if="commentaries.length > 0">
                    ...
                    <v-card
                        class="py-4 pb-0 color--white d-flex flex-column justify-center align-center"
                    >
                        <div
...
export default {
    ...
    methods: {
        ...
        deleteComment(id, index) {
            this.$axios
                .delete(`api/v1/news-commentaries/${id}`, {
                    withCredentials: true,
                    headers: {
                        Authorization: `Bearer ${this.accessToken}`,
                    },
                ...
                .then((res) =>
                    this.newsComments.splice(
                        this.newsComments.findIndex((item) => item.id == id),
                        1
                    )
                );
        },

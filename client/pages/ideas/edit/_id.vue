...
export default {
    head() {
        let descr =
                "Редактировать идею для факультета информационных систем и технологий",
    ...
    async created() {
        ...
        this.idea = (
            await this.$axios.get(`/api/v1/ideas/${this.ideaId}`, {
    ...
    methods: {
        ...
        async saveIdea() {
            ...
            this.counter++;
            this.$axios
                .patch(`/api/v1/ideas/${this.ideaId}/`, formData, {
                    withCredentials: true,
                    headers: {

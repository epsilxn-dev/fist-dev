                ...
                <v-card>
                    <v-card-text class="pa-2 pa-md-4">
                        <v-container class="image_input mt-4"
                            :class="{ redBorder: $v.idea.image.$dirty && $v.idea.image.$invalid }"
                            @click="$v.idea.image.$touch()">
                            <ImageInput
                                :background="background"
                                @input="$v.idea.image.$touch()"
                                @blur="$v.idea.image.$touch()"
                                @change="setImage" :rules="rules"
                            ></ImageInput>
                        </v-container>
                        <v-container>
                            ...
                            <v-autocomplete
                                ...
                                chips
                                small-chips label="Укажите username"
                                multiple
                                outlined
                            ></v-autocomplete>
                        </v-container>
                    ...
                    <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn nuxt to="/ideas" class="mr-4 caption" color="red lighten-2 pa-4">Отмена</v-btn>
...
export default {
    ...
    head() {
        let descr = 'Предложить идею для факультета информационных систем и технологий',
    ...
    methods: {
        ...
        async saveIdea() {
            ...
            this.$axios.post(`api/v1/ideas/`, formData,
                {

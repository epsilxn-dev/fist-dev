            ...
            <v-col class="col col-12 col-md-8">
                ...
                <div class="mt-4 d-flex">
                    <div class="d-none d-md-block">
                        <v-avatar size="200px">
                            <v-img
                                class="mr-5 teach_img"
                                :src="base + teacher.avatar"
                            />
                        </v-avatar>
                    </div>
                    <div
                        class="d-flex flex-column align-center align-md-start justify-center"
                    >
                        <div class="d-block d-md-none">
                            <v-avatar size="200px">
                                <v-img
                                    class="mr-0 mr-md-5 teach_img"
                                    :src="base + teacher.avatar"
                                />
                            </v-avatar>
                        </div>
                        <h2 class="text-h5 text--primary mt-4">
                            {{ teacher.last_name }} {{ teacher.first_name }}
                            {{ teacher.patronymic }}
                        </h2>
                        <h2 class="text-h5 text--secondary mt-4">
                            {{ teacher.science_rank }}
                        </h2>
                        <div
                            class="subtitle-1 text-center text-md-left text--secondary mt-4"
                            v-html="teacher.information"
                        ></div>
                ...
                <h2 class="text-h4 text-center text-md-left text--primary mt-4">
                    Дисциплины:
                </h2>

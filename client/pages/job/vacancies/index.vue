        ...
        <v-row no-gutters>
            ...
            <v-col class="col col-md-7 col-12">
                <v-container v-if="filteredVacancies.length != 0">
                    <VacancieItem
                        v-for="(vacancie, index) in filteredVacancies"
                        :key="index"
                        :vacancie="vacancie"
                    />
...
export default {
    ...
    async fetch() {
        ...
        this.$axios
            .get("https://api.hh.ru/vacancies?area=1614&text=Разработчик")
            .then((res) => {
    ...
    methods: {
        ...
        showMore() {
            this.toShow += 7;
            if (this.toShow > this.vacancies.length)
                this.toShow = this.vacancies.length;
        },
    },
    computed: {
        filteredVacancies() {
            ...
            let result = !this.filters.reverse
                ? vacancies
                : vacancies.reverse();

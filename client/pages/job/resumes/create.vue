                ...
                <v-card>
                    <v-card-text class="pa-2 pa-md-4">
                        ...
                        <v-radio-group :error-messages="sexErrors" v-model="sex">
                            ...
                            <v-radio :label="'Не указан'" :value="'Не указан'"></v-radio>
                        ...
                        <v-container>
                            ...
                            <v-text-field clearable v-model="work_exp" class="my-1" outlined label="Опыт работы">
                            </v-text-field>
...
export default {
    ...
    async created() {
        ...
        this.$store.dispatch('lk/setResume', user.id).then(res => {
            resume = res
    ...
    methods: {
        ...
        saveResume() {
            ...
            this.$axios.post(`api/v1/resumes/`, formData,
                {

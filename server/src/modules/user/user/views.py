...
from src.modules.user.identification.utils import request_email_confirmation
from .sersizliers import UserSerializer
from .utils import check_password_by_request
...
class UserUsernameChange(APIView):
    permission_classes = [IsAuthenticated]
    swagger_tags = [TAG]
    ...
    def patch(self, request: Request, *args, **kwargs):
        ...
        return Response("Поле username не было предоставлено", status=400)
